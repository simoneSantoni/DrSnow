...
%% substantive relevance
The lack of substantive relevance is one of the most common terrains in which
naturally-occurring events are criticized. For instance, in his critical analysis of the 
Instrumental Variable (IV) applications,\footnote{It is commonly accepted that 
natural experiments' forms include the `Instrumental Variable' design
along with the `Standard Natural Experiment' and `Regression Discontinuity
Design,'  constitutes the three forms of natural experiments
\parencite{sieweke_santoni_2020,dunning_2012}.} Deaton 
\parencite*{deaton_2009} observes that:
...
Heckaman and Urzua \parencite{heckman_urzua_2010} express a similar concern by emphasizing:
